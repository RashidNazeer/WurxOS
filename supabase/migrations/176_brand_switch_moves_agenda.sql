-- ============================================================
-- WurxOS v2 — Migration 176: brand_switch_apc also moves agenda
-- tasks + agenda resources.
--
-- Mig 170 made a brand switch carry the brand's tasks, reports and
-- resources to the new APC. The Weekly Agenda Meetings module
-- (mig 175) adds two more brand-tagged tables — agenda_tasks and
-- agenda_resources — that must follow the same rule, so a switched
-- brand's meeting tasks/resources stay anchored to whoever runs it.
--
-- This recreates brand_switch_apc with the mig-170 body verbatim
-- plus an agenda_tasks / agenda_resources transfer in each swap
-- direction. Idempotent (CREATE OR REPLACE).
-- ============================================================
