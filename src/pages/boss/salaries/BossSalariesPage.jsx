...
import {
  listAllCompensation, formatPKR, yearsCompletedSince, setUserHireDate,
    ...
    <>
      ...
      {tab === 'pending' && (
        <ComingSoonStub
          ...
          body="This tab will surface every employee whose anniversary has passed without a salary review — landing in a follow-up phase."
        />
      )}
      ...
      {tab === 'history' && (
        <ComingSoonStub
          ...
          body="Cross-employee audit feed of every salary change. Per-employee history is already visible inside each Review modal — landing in a follow-up phase."
        />
      )}
