  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        /* ── My Incentives Tab ── */
        !myRecord ? (
          <div className="text-center py-5 rounded-4" style={{ border: '2px dashed #dee2e6', background: '#fff', maxWidth: 600 }}>
            <div className="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3" style={{ width: 64, height: 64, background: '#f8f9fa' }}>
