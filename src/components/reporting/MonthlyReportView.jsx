  ...
  return (
    <div>
      ...
      <div ref={printRef} className="report-canvas" style={{ background: C.surfaceAlt, padding: '24px', borderRadius: 18, border: `1px solid ${C.line}` }}>
        ...
        {/* ─── Key Wins & Insights ───────────────────────────────────
            Rendered here, in its section order (after the metric sections,
            before trends + long-form) — NOT bunched at the top after
            Overall Performance, matching where the author adds it. */}
